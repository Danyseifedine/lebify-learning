...
class UpdateConfigFile extends Command
{
     ...
     * @var string
     */
    protected $signature = 'update:config-js';
     ...
     * @var string
     */
    protected $description = 'Update the config.js file with the provided code';
    ...
    {
        $configJsFilePath = public_path('js/common/base/config/config.js');
...
JS;
        ...
        $this->addCodeToFile($configJsFilePath, $code);
        $this->info('The config.js file has been updated successfully.');
    }
}
