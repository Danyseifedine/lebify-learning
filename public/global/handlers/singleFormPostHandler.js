...
import { serializeForm } from '../utils/form-utils.js';
...
export class SingleFormPostHandler extends Identifiable {
    ...
    async handleButtonClick(event) {
        ...
        if (RateLimiter.isLimited(form)) {
            errorLogger.logWarning('Form submission rate limited');
            return;
        }
    ...
    async submitForm(form, button, endpoint) {
        ...
        try {
            ...
            const data = serializeForm(form, serializationType);
            ...
            errorLogger.logError('Error submitting form', error);
