/*=============================================================================
 * CourseExtention Management Module
 *
 * This module handles all courseExtention-related operations in the dashboard including:
...
import { initSelect2, goToUrlReload } from '../../../core/global/utils/functions.js';
 ...
 * @function buildApiUrl - Constructs API endpoints for courseExtention operations
 *--------------------------------------------------------------------------*/
const defaultErrorHandler = (err) => console.error('Error:', err);
const reloadDataTable = () => courseextentionTable.reload();
const buildApiUrl = (path) => `${DASHBOARD_URL}/courses/extensions/${path}`;
 ...
 * Defines the structure and behavior of the CourseExtention management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id",
...
const tableColumnDefinitions = [
    ...
    {
        targets: [3], orderable: false, htmlType: 'link',
    },
    {
        targets: [-1],
        htmlType: 'actions',
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected courseExtentions
 * @param {Array} selectedIds - Array of selected courseExtention IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple courseExtentions, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main courseExtention management interface
 *============================================================================*/
// Add a namespace prefix for filter selects
const FILTER_PREFIX = 'filter_';


export const courseextentionTable = new $DatatableController('courseextentionTable', {
...
// Initialize create courseExtention modal
createModalLoader({
