/*=============================================================================
 * CourseRelatedChannel Management Module
 *
 * This module handles all courseRelatedChannel-related operations in the dashboard including:
 ...
 * @function buildApiUrl - Constructs API endpoints for courseRelatedChannel operations
 *--------------------------------------------------------------------------*/
const defaultErrorHandler = (err) => console.error('Error:', err);
const reloadDataTable = () => courserelatedchannelTable.reload();
const buildApiUrl = (path) => `${DASHBOARD_URL}/courses/relatedChannels/${path}`;
 ...
 * Defines the structure and behavior of the CourseRelatedChannel management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id"
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected courseRelatedChannels
 * @param {Array} selectedIds - Array of selected courseRelatedChannel IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple courseRelatedChannels, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main courseRelatedChannel management interface
 *============================================================================*/

// Add a namespace prefix for filter selects
const FILTER_PREFIX = 'filter_';

export const courserelatedchannelTable = new $DatatableController('courserelatedchannelTable', {
...
// Initialize create courseRelatedChannel modal
createModalLoader({
