/*=============================================================================
 * CourseResource Management Module
 *
 * This module handles all courseResource-related operations in the dashboard including:
 ...
 * @function buildApiUrl - Constructs API endpoints for courseResource operations
 *--------------------------------------------------------------------------*/
const defaultErrorHandler = (err) => console.error('Error:', err);
const reloadDataTable = () => courseresourceTable.reload();
const buildApiUrl = (path) => `${DASHBOARD_URL}/courses/resources/${path}`;
 ...
 * Defines the structure and behavior of the CourseResource management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id"
...
const tableColumnDefinitions = [
    ...
    { targets: [4], orderable: false, htmlType: 'toggle', dataClassName: "status-toggle" },
    {
        targets: [-1],
        htmlType: 'actions',
        className: 'text-end',
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected courseResources
 * @param {Array} selectedIds - Array of selected courseResource IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple courseResources, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main courseResource management interface
 *============================================================================*/

// Add a namespace prefix for filter selects
const FILTER_PREFIX = 'filter_';

export const courseresourceTable = new $DatatableController('courseresourceTable', {
...
// Initialize create courseResource modal
createModalLoader({
