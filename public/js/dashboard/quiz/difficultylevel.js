/*=============================================================================
 * DifficultyLevel Management Module
 *
 * This module handles all difficultyLevel-related operations in the dashboard including:
 ...
 * @function buildApiUrl - Constructs API endpoints for difficultyLevel operations
 *--------------------------------------------------------------------------*/
const defaultErrorHandler = (err) => console.error('Error:', err);
const reloadDataTable = () => difficultylevelTable.reload();
const buildApiUrl = (path) => `${DASHBOARD_URL}/quiz/difficultylevels/${path}`;
 ...
 * Defines the structure and behavior of the DifficultyLevel management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id"
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected difficultyLevels
 * @param {Array} selectedIds - Array of selected difficultyLevel IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple difficultyLevels, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main difficultyLevel management interface
 *============================================================================*/
export const difficultylevelTable = new $DatatableController('difficultylevelTable', {
...
// Initialize create difficultyLevel modal
createModalLoader({
