/*=============================================================================
 * QuestionCategory Management Module
 *
 * This module handles all questionCategory-related operations in the dashboard including:
 ...
 * @function buildApiUrl - Constructs API endpoints for questionCategory operations
 *--------------------------------------------------------------------------*/
const defaultErrorHandler = (err) => console.error('Error:', err);
const reloadDataTable = () => questionCategoryTable.reload();
const buildApiUrl = (path) => `${DASHBOARD_URL}/quiz/questions/categories/${path}`;
 ...
 * Defines the structure and behavior of the QuestionCategory management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id"
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected questionCategorys
 * @param {Array} selectedIds - Array of selected questionCategory IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple questionCategorys, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main questionCategory management interface
 *============================================================================*/
export const questionCategoryTable = new $DatatableController('questionCategoryTable', {
...
// Initialize create questionCategory modal
createModalLoader({
