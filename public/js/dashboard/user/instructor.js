 ...
 *
 * This module handles all instructor-related operations in the dashboard including:
 ...
 * @function buildApiUrl - Constructs API endpoints for instructor operations
 *--------------------------------------------------------------------------*/
const defaultErrorHandler = (err) => console.error('Error:', err);
const reloadDataTable = () => instructorTable.reload();
const buildApiUrl = (path) => `${DASHBOARD_URL}/users/instructors/${path}`;
 ...
 * Defines the structure and behavior of the Instructor management table
 *--------------------------------------------------------------------------*/
const tableColumns = [
    {
        "data": "id"
...
/*---------------------------------------------------------------------------
 * Bulk Action Handler
 * Processes operations on multiple selected instructors
 * @param {Array} selectedIds - Array of selected instructor IDs
 *--------------------------------------------------------------------------*/
const handleBulkActions = (selectedIds) => {
    // Implementation for bulk actions
    // Example: Delete multiple instructors, change status, etc.
};

/*=============================================================================
 * DataTable Initialization
 * Creates and configures the main instructor management interface
 *============================================================================*/
export const instructorTable = new $DatatableController('instructorTable', {
...
// Initialize create instructor modal
createModalLoader({
