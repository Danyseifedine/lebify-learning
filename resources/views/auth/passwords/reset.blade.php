                        ...
                        <form form-id="reset" feedback route="{{ route('password.update') }}"
                            ...
                            <div class="fv-row mb-8">
                                ...
                                <input type="text" placeholder="{{ __('common.email') }}" id="email" name="email"
                                    autocomplete="off" feedback-id="email-feedback"
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="position-relative mb-3">
                                        <input
                                            ...
                                            type="password" placeholder="{{ __('common.password') }}" name="password"
                                            autocomplete="off" feedback-id="password-feedback" id="password">
                                        <span
