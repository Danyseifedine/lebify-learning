...
@section('toolbar')
    @include('dashboard.common.toolbar', [
        'title' => 'CourseLesson',
        'currentPage' => 'CourseLesson Management',
    ])
@endsection
...
@php
    $columns = ['course_id', 'title', 'duration', 'is_published', 'views_count', 'actions'];
@endphp
...
---------------------------->
@section('content')
    <x-lebify-table id="courselessonTable" :columns="$columns" {{-- create="true"                         // BY DEFAULT TRUE
...
---------------------------->
@push('scripts')
<script src="{{ asset('js/dashboard/course/lesson.js') }}" type="module" defer></script>
@endpush
