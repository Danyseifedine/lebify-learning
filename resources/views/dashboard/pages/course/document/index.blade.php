...
@section('toolbar')
    @include('dashboard.common.toolbar', [
        ...
        'currentPage' => 'CourseDocument Management',
    ])
@endsection
...
@php
    $columns = ['course_id', 'title_en', 'order', 'actions'];
@endphp
...
---------------------------->
@section('content')
    <x-lebify-table id="coursedocumentTable" :columns="$columns" {{-- create="true"                         // BY DEFAULT TRUE
...
<script src="{{ asset('js/dashboard/course/document.js') }}" type="module" defer></script>
@endpush
