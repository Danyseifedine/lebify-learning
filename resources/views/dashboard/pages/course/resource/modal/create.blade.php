<form id="create-courseResource-form" form-id="createForm" http-request
    route="{{ route('dashboard.courses.resources.store') }}" identifier="single-form-post-handler" feedback close-modal
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control form-control-solid" name="description_en" id="description_en"
            feedback-id="description_en-feedback"></textarea>
        <div id="description_en-feedback" class="invalid-feedback"></div>
    </div>
    <div class="mb-3">
        <label for="url" class="form-label">Url</label>
        <input type="text" class="form-control form-control-solid" name="url" id="url" feedback-id="url-feedback">
