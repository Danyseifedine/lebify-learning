...
@section('title', 'Course Extention')
...
@section('toolbar')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        <!--begin::Title-->
        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Course Extention
        </h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
    ...
    <div class="row g-6 g-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <!-- start table -->
                <table id="courseExtention-datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                    <thead>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="create-courseExtention-form">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="marketplace_url" id="marketplace_url">
                        </div>
                        <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" with-spinner="true" class="btn btn-primary"
                        id="create-courseExtention-button">
    ...
    <div class="modal fade" tabindex="-1" id="edit-modal" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="edit-courseExtention-form">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn close-modal btn-light">Close</button>
                    <button type="button" with-spinner="true" class="btn btn-primary" id="edit-courseExtention-button">
...
@push('scripts')
    <script src="{{ asset('js/web/dashboard/courses/courseExtention.js') }}" type="module"></script>
@endpush
