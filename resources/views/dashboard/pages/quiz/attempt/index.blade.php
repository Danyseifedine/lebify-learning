...
@section('toolbar')
    @include('dashboard.common.toolbar', [
        'title' => 'QuizAttempt',
        'currentPage' => 'QuizAttempt Management',
    ])
@endsection
...
@php
    $columns = ['quiz_id', 'user_id', 'score', 'passed', 'status', 'actions'];
@endphp
...
---------------------------->
@section('content')
    <x-lebify-table id="quizAttemptTable" :columns="$columns" {{-- create="true"                         // BY DEFAULT TRUE
...
---------------------------->
@push('scripts')
<script src="{{ asset('js/dashboard/quiz/attempt.js') }}" type="module" defer></script>
@endpush
