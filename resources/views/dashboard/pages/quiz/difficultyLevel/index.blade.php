...
@section('toolbar')
    @include('dashboard.common.toolbar', [
        ...
        'currentPage' => 'DifficultyLevel Management',
    ])
@endsection
...
---------------------------->
@section('content')
    <x-lebify-table id="difficultylevelTable" :columns="$columns" :filter="false">
...
---------------------------->
@push('scripts')
<script src="{{ asset('js/dashboard/quiz/difficultyLevel.js') }}" type="module" defer></script>
@endpush
