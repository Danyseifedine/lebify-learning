...
@section('toolbar')
    @include('dashboard.common.toolbar', [
        ...
        'currentPage' => 'QuestionCategory Management',
    ])
@endsection
...
---------------------------->
@section('content')
    <x-lebify-table id="questionCategoryTable" :columns="$columns" :filter="false">
...
---------------------------->
@push('scripts')
<script src="{{ asset('js/dashboard/quiz/questionCategory.js') }}" type="module" defer></script>
@endpush
