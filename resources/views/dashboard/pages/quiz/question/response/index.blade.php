...
@section('toolbar')
    @include('dashboard.common.toolbar', [
        ...
        'currentPage' => 'Quiz Responses Management',
    ])
@endsection
...
---------------------------->
@section('content')
    <x-lebify-table id="quizresponseTable" :columns="$columns" :create="false" :selected="false" :filter="false"
        :showCheckbox="false">
...
---------------------------->
@push('scripts')
<script src="{{ asset('js/dashboard/quiz/quizResponse.js') }}" type="module" defer></script>
@endpush
