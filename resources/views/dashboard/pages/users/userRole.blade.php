...
@section('toolbar')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        <!--begin::Title-->
        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">User Role</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
    ...
    <div class="row g-6 g-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <!-- start table -->
                <table id="userRole-datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                    <thead>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" with-spinner="true" class="btn btn-primary" id="create-userRole-button">
    ...
    <div class="modal fade" tabindex="-1" id="edit-modal" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn close-modal close-modal btn-light">Close</button>
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script src="{{ asset('js/web/dashboard/users/userRole.js', true) }}" type="module"></script>
@endpush
