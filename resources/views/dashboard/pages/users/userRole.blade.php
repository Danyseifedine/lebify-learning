...
@section('toolbar')
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        <!--begin::Title-->
        <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">userRole</h1>
        <!--end::Title-->
        <!--begin::Breadcrumb-->
...
@push('scripts')
    <script src="{{ asset('js/web/dashboard/users/userRole.js') }}" type="module"></script>
@endpush
