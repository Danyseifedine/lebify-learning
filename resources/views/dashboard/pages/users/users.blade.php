...
@section('content')
            ...
            <div class="card-body">
                <div class="datatable-body mb-5">
                    ...
                    <div class="d-flex filter-toolbar flex-wrap align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="filter-menu"
                            style="">
                            <div class="px-7 py-5">
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="d-flex justify-content-end">
                                    <button data-kt-docs-table-filter="reset" type="reset"
                                        class="btn btn-sm btn-light btn-active-light-primary me-2" data-table-reset="filter"
                ...
                <!-- start table -->
                <table id="users-datatable" class="table align-middle table-row-dashed fs-6 gy-5">
                    <thead>
    ...
    <!-- start create modal -->
    <div class="modal fade" tabindex="-1" identifier="modal-handler" clear-forms id="create-modal">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form form-id="create-users-form" http-request route="{{ route('dashboard.users.store') }}"
                        identifier="single-form-post-handler" on-success="onSuccess" success-toast close-modal
                        serialize-as="formdata" feedback>
                        <div class="mb-3">
                            <label for="name" class="form-label">name</label>
                            <input type="text" class="form-control" name="name" feedback-id="name-feedback"
                                id="name">
                            <div class="invalid-feedback" id="name-feedback"></div>
                        </div>
                        <div class="mb-3">
                            <label for="age" class="form-label">age</label>
                            <input type="text" class="form-control" name="age" feedback-id="age-feedback"
                                id="age">
                            <div class="invalid-feedback" id="age-feedback"></div>
                        </div>
                        <div class="mb-3">
                            <label for="phone" class="form-label">phone</label>
                            <input type="text" class="form-control" name="phone" feedback-id="phone-feedback"
                                id="phone">
                ...
                <div class="modal-footer">
                    <button type="button" data-bs-dismiss="modal" class="btn close-modal btn-light">Close</button>
                    <button type="submit" class="btn btn-primary" submit-form-id="create-users-form">Submit</button>
...
@push('scripts')
    <script src="{{ asset('js/web/dashboard/users/users.js', true) }}" type="module"></script>
@endpush
