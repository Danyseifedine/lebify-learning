...
<body id="body" class="app-default" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px"
    ...
    <div class="d-flex flex-column app-bg flex-root app-root" style="background-image: url({{ asset("vendor/img/bg/wallet-bg.svg") }}); background-size: cover; background-position: center;background-repeat: no-repeat;" id="kt_app_root">
                            ...
                            <div class="d-flex flex-lg-row-fluid">
                                ...
                                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                                    ...
                                    <img class="mx-auto mw-100 w-300px w-lg-600px"
                                        src="{{ asset("vendor/img/bg/wallet.svg") }}" alt="">
                                    <!--end::Image-->
                                    <!--begin::Title-->
