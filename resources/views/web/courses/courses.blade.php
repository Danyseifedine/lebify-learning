...
@section('content')
    <div style="padding-top: 53px !important;">
        <section class="p-20 text-center"
            style="background-image: url('{{ asset('vendor/img/bg/banner-bg.svg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat;background-size: cover;">
            <div class="container">
    ...
    <section class="container app-bg py-5">
            ...
            @foreach ($courses as $course)
                @if ($course->is_published || Auth::user()->hasRole('admin'))
                    ...
                    <div class="col-md-6 col-xl-4">
                        <!--begin::Card-->
                        <a href="" class="card shadow-course-card">
                            <!--begin::Card header-->
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="d-flex flex-wrap mb-5">
                                    ...
                                    <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mb-3">
                                        <div class="fs-6 text-gray-800 fw-bold">{{ $course->created_at->format('d M Y') }}
                                        </div>
                                ...
                                <div class="h-4px w-100 bg-light mb-5" data-bs-toggle="tooltip"
                                    aria-label="Difficulty Level: {{ $course->difficulty_level }}"
