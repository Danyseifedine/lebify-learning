        ...
        <div class="container">
                ...
                <div class="col-md-3 helpful-links">
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div class="hover-elevate-up" data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-custom-class="resource-tooltip" title="{{ $resource->getDescription() }}">
                    ...
                    <img src="{{ asset('vendor/img/icon/not-available-light.svg') }}" width="100"
            ...
            <div class="row lessons mt-12">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="d-none d-md-block">
                        <img class="theme-light-show" src="{{ asset('vendor/img/default/arrow-up-light.svg') }}" alt=""
                            width="70"
                            style="position: relative;bottom: 15px !important;opacity: 0.5;{{ app()->getLocale() == 'ar' ? 'transform: scaleX(-1);' : '' }}">
                        <img class="theme-dark-show" src="{{ asset('vendor/img/default/arrow-up-dark.svg') }}" alt=""
                            width="70"
                            style="position: relative;bottom: 15px !important;opacity: 0.5;{{ app()->getLocale() == 'ar' ? 'transform: scaleX(-1);' : '' }}">
                    </div>
                </div>
                                ...
                                <div class="card-body p-4 p-lg-6 d-flex flex-column h-100">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-4">
                                        ...
                                        <span class="badge bg-danger text-white px-3 py-2 rounded-pill">
                                            <i class="far fa-clock px-1 fs-3 text-white me-1"></i>
                                            {{ $lesson->duration_for_humans }}
                                        </span>
                                    </div>

                                    <!-- Description -->
                                    <p class="card-text mb-4 flex-grow-1" style="text-align: justify; color: #6c757d;">
                                        {{ $lesson->description }}
                                    </p>

                                    <!-- Footer Actions -->
                                    <div class="d-flex flex-column justify-content-between flex-md-row gap-3 mt-auto">
                                        <button type="button"
                                            class="btn d-flex align-items-center justify-content-center bg-logo w-100 w-md-auto"
                                            data-bs-toggle="modal" data-bs-target="#videoModal{{ $lesson->id }}">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content bg-dark">
                            <div class="modal-header border-0">
                                <h5 class="modal-title text-white" id="videoModalLabel{{ $lesson->id }}">
                                    {{ $lesson->title }}
                                </h5>
                            ...
                            <div class="modal-body p-0">
                                <div class="ratio ratio-16x9">
                                    <iframe src="{{ $lesson->embed_video_url }}" class="rounded-0" frameborder="0"
                                        loading="lazy"
                ...
                <div class="col-12 text-center">
                    ...
                    <img src="{{ asset('vendor/img/icon/not-available-light.svg') }}" width="100" alt="Empty Lessons">
                </div>
                @endif
            </div>
            ...
            <div class="row extension mt-12">
                    ...
                    <div class="col">
                        <div class="card h-100 border-0 shadow-sm hover-elevate-up">
                            <div class="card-body p-4">
                                <!-- Extension Icon/Logo -->
                                <div class="d-flex btn-sm btn-light justify-content-between align-items-center mb-4">
                                    ...
                                    <button class="btn border-logo d-flex align-items-center gap-1 small"
                                        data-bs-toggle="modal" data-bs-target="#extensionModal{{ $extension->id }}">
                ...
                <div class="col-12 text-center">
                    ...
                    <img src="{{ asset('vendor/img/icon/not-available-light.svg') }}" width="100" alt="Empty Extensions"
                        class="mt-4">
                </div>
                @endif
            </div>
            ...
            <div class="row related-channels mt-12">
                ...
                <div class="col-12 text-center">
                    ...
                    <img src="{{ asset('vendor/img/icon/not-available-light.svg') }}" width="100" alt="">
