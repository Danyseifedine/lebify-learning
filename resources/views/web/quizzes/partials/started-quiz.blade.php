...
<style>
    ...
    /* Clean Security Alert Modal Styling */
    ...
    .violation-counter .current {
        font-size: 1.25rem;
        font-weight: 700;
        color: #ffc107;
    }

    .violation-counter .separator {
        font-size: 0.9rem;
        color: #777;
    }

    .violation-counter .max {
        font-size: 1.25rem;
        font-weight: 700;
        color: #aaa;
    }
    ...
    .alert-warning-footer i {
        color: #ffc107;
        font-size: 1.1rem;
        margin-top: 0.1rem;
    }

    .alert-warning-footer p {
        font-size: 0.9rem;
        color: #dddddd;
        margin: 0;
        line-height: 1.4;
    ...
    .termination-popup .security-alert-header {
        color: #dc3545;
    }
